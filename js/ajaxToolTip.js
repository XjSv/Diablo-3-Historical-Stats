...
var ajaxtooltip = {
    ...
    loadingHTML: '<div style="font-style:italic"><img src="../img/ajaxload.gif">Fetching Tooltip...</div>',
...
jQuery(document).ready(function() {
    ...
    $('*[@title^="ajax:"]').each(function(index) { //find all links with "title=ajax:" declaration
        ...
        $target.hover(function(e) { //onMouseover element
            ...
            if (!$tooltip.get(0).loadsuccess) { //first time fetching Ajax content for this tooltip?
                ...
                var tooltipParams = $(this).rel('data-d3tooltip');
